...
class UserController extends Controller
{
    public function index(): View
    {
        ...
        return view('user.index', compact('company_id'));
    }
    ...
    public function category(Request $request)
    {
        ...
        return view('user.analysis.reportview.index', compact('companies', 'company_id', 'data', 'startDate', 'endDate', 'grouped_entities', 'estado', 'gerencia', 'superintendencia', 'taller_seccion'));
    }
    ...
    public function categoryDetail(Request $request, $category_name)
    {
        ...
        return view('user.analysis.reportview.toquepala.category', compact('data', 'category_name', 'grouped_entities', 'startDate', 'endDate', 'estado', 'gerencia', 'superintendencia', 'taller_seccion'));
    }
    ...
    public function categoryYear(Request $request)
    {
        ...
        return view('user.analysis.reportview.toqcurvatendencia.index', compact('data', 'otro_select', 'tipo_reporte', 'startYear', 'grouped_entities', 'estado', 'gerencia', 'superintendencia', 'taller_seccion'));
    }
    ...
    public function inspeccion(Request $request)
    {
        ...
        return view('user.analysis.reportview.inspeccion.index', compact('companies', 'company_id', 'data', 'startDate', 'endDate', 'grouped_entities', 'estado', 'gerencia', 'superintendencia', 'taller_seccion'));
    }
    ...
    public function inspeccionDetail(Request $request)
    {
        ...
        return view('user.analysis.reportview.inspecciondetalle.index', compact('companies', 'company_id', 'data', 'category_name', 'grouped_entities', 'startDate', 'endDate', 'estado', 'gerencia', 'superintendencia', 'taller_seccion'));
    }
    public function inspeccionYear(Request $request)
    {
        ...
        return view('user.analysis.reportview.inspeccioncurvadetendencia.index', compact('companies', 'company_id', 'data', 'otro_select', 'tipo_reporte', 'startYear', 'grouped_entities', 'estado', 'gerencia', 'superintendencia', 'taller_seccion'));
    }
}
