                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-muted/50 border-b">
                                ...
                                <TableHead className="h-8 border-r py-2" colSpan={1}>
                                    Estado
                                </TableHead>
                                        ...
                                        <TableRow key={causa.id}>
                                            ...
                                            <TableCell className="text-center">
                                                <Select
                                                    ...
                                                    onValueChange={(value) =>
                                                        handleCausaStateChange(causa.id, value, causaStates.find((c) => c.id === causa.id)?.observation || '')
                                                    }
                                                >
                                                    <SelectTrigger className="w-full">
                                            ...
                                            <TableCell>
                                                <Input
                                                    ...
                                                    onChange={(e) =>
                                                        handleCausaStateChange(causa.id, undefined as any, e.target.value)
                                                    }
                                                />
                                            </TableCell>
                                        </TableRow>
