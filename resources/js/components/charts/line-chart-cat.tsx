...
const calculateTotals = (data) => {
    return data.reduce(
        (acc, item) => {
            acc.actos += item.actos;
            acc.incidentes += item.incidentes;
            acc.condiciones += item.condiciones;
            return acc;
        },
        { actos: 0, incidentes: 0, condiciones: 0 },
    );
};

const LineChartComponentCAT: React.FC = () => {
                ...
                {loading ? (
                    ...
                    <>
                        <div className="mb-4 flex justify-around">
                            <div>
                                <strong>Actos:</strong> {totals.actos}
                            </div>
                            <div>
                                <strong>Incidentes:</strong> {totals.incidentes}
                            </div>
                            <div>
                                <strong>Condiciones:</strong> {totals.condiciones}
                            </div>
                        </div>
...
export default LineChartComponentCAT;
